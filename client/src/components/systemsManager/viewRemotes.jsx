...
const rows = [createData("xyz", 159, 6.0, 24, 4.0)];
	...
	return (
		<div className={classes.root}>
			<AppBar position='static' color='default'>
				...
				>
					<Tab label='Lab One' {...a11yProps(0)} />
					<Tab label='Lab Two' {...a11yProps(1)} />
					<Tab label='Lab Three' {...a11yProps(2)} />
					<Tab label='Lab Four' {...a11yProps(3)} />
					{/* <Tab label='Item Five' {...a11yProps(4)} />
					<Tab label='Item Six' {...a11yProps(5)} />
					<Tab label='Item Seven' {...a11yProps(6)} /> */}
				</Tabs>
			</AppBar>
			<TabPanel value={value} index={0} style={{ margin: "0 50px" }}>
